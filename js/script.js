...
//dropdwon web design navbar
document.addEventListener("DOMContentLoaded", function () {
    const dropdownToggle = document.getElementById("WebdesignDropdown");

    dropdownToggle.addEventListener("click", function (e) {
        e.preventDefault(); // redirect rok do
        this.parentElement.classList.toggle("show"); // parent <li> par class toggle
        this.nextElementSibling.classList.toggle("show"); // dropdown menu toggle
    });
});
